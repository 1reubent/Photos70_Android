...
public class Photo implements Serializable {
    ...
    public boolean hasTagPrefix(String tagType, String tagValue) {
        if (tagType.equalsIgnoreCase("people")) {
            return peopleTags.stream().anyMatch(tag -> tag.startsWith(tagValue.toLowerCase()));
        } else if (tagType.equalsIgnoreCase("location")) {
            return locationTag != null && locationTag.toLowerCase().startsWith(tagValue.toLowerCase());
        }
        return false;
    }
